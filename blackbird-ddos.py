...
def show_intro():
    ...
    print("╠════════════════════════════════════════════════════════════╣")
    print("║ 👤 Name       : @QUANTUM_NULL                           ║")
    print("║ 🌐 Telegram Channel : t.me/NCBLACKBIRD                          ║")
    print("║ 🅾 Telegram Id  : @QUANTUM_NULL                           ║")
...
def show_banner():
    ...
    print("""\033[95m
╔══════════════════════════════════════════════════════════╗
║         ☠️ BLACKBIRD DDOS v9 – WORLD BREAKER ☠️               ║
║  🔥 Coded by: @NCBLACKBIRD | Proxy + Multi-Vector Engine 🔥    ║
╠══════════════════════════════════════════════════════════╣
║  🚀 Max Threads   : {:>8}                               ║
...
def start_ui():
    ...
    print("\033[96m")
    print("╔════════════════════════════════════════════╗")
    print("║        🔥 BLACKBIRD DDOS TOOLKIT UI MENU 🔥      ║")
    print("╠════════════════════════════════════════════╣")
